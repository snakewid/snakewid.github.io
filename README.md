...
1.INTRODUCTION Welcome to use Snake FlashLight Widget! Your use of Product is subject to these Terms (“Service” or “Our Service”).

The Snake FlashLight Widget a night patrol. The best weapon in the dark against ungodliness. Absolutely free and unique application.

Your use of Snake FlashLight Widget is subject to the terms and conditions of these Terms of Use (“Terms”). Please read these Terms carefully.

You must comply with these Terms in your use of Snake FlashLight Widget and only use Snake FlashLight Widget as permitted by applicable laws and regulations, wherever you may be when you use it. You must review these Terms to understand how you can and cannot use Snake FlashLight Widget. If you do not agree to these Terms, you must not download or install or otherwise use Snake FlashLight Widget.
...
2.CONTRACTING ENTITY By downloading, installing and using Snake FlashLight Widget, you are agreeing to be bound by these Terms between you and Snake FlashLight Widget Team (“We”, “Our” and “Us”).
...
5.SCOPE OF LICENSE Although we continue to own Snake FlashLight Widget, after your acceptance of these Terms you will have certain rights to use Snake FlashLight Widget during the entire time period when Snake FlashLight Widget is installed on your mobile device. All rights not expressly granted to you are retained by us. These Terms govern any releases, revisions, updates or enhancements to Snake FlashLight Widget that we may make available to you.

You may install, use, display and run Snake FlashLight Widget in a personal computer (“Device”) solely for non-commercial purposes and in accordance with these Terms. Installation, use, display or operation of Snake FlashLight Widget for commercial purposes is forbidden.

You shall have the right to receive new features to and versions of Snake FlashLight Widget as we, in our sole discretion, make such features and versions available. In order to optimize Snake FlashLight Widget, and to provide you with the most current version of Snake FlashLight Widget, you agree Snake FlashLight Widget can automatically download and install new updates and versions of the Snake FlashLight Widget as they are made available by us in our sole discretion. You agree to receive and permit us to deliver such new updates and versions to your mobile device. Additionally, we may modify these Terms to reflect such updates and versions and you agree to such updated terms.

You may not copy, modify, reverse compile, reverse engineer or extract source codes from Snake FlashLight Widget, except to the extent that we may not prohibit you from doing so under applicable laws or regulations or you have our prior written consent to do so. Where applicable laws or regulations entitle you to reverse compile or extract source codes from Snake FlashLight Widget, you will first contact us to request the information you need.
...
a)the collection of the information as how you use Snake FlashLight Widget (such as the time when you install Snake FlashLight Widget, version of Snake FlashLight Widget you are using, how you use the various functions and features that available to you), the information about your mobile device (such asthe operating system, hardware version, device settings, device identifiers) and your communication with us
...
10.TERMINATION These Terms will apply to your use of Snake FlashLight Widget and Our Service until access to the relevant services is terminated by either you or us.
